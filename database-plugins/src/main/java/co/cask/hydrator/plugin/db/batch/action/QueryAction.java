...
public class QueryAction extends PostAction {
  ...
  private final PostActionQueryConfig config;

  public QueryAction(PostActionQueryConfig config) {
    this.config = config;
  }
  ...
  public void run(BatchActionContext batchContext) throws Exception {
    ...
    Class<? extends Driver> driverClass = batchContext.loadPluginClass(config.JDBC_PLUGIN_NAME);
  ...
  public void configurePipeline(PipelineConfigurer pipelineConfigurer) throws IllegalArgumentException {
    ...
    dbManager.validateJDBCPluginPipeline(pipelineConfigurer, config.JDBC_PLUGIN_NAME);
  }

  /**
   * Config for {@link QueryAction}
   */
  public class PostActionQueryConfig extends QueryConfig {
    @Nullable
